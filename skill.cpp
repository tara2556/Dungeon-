...
void Skill::activateSkill(Object* object) {
	...
	case 2:
		switch (this->level) {
		case 0:
			player->setAddHp(player->getMaxHealth() * 0.1);
			player->revive(player->getMaxHealth() * 0.1);
			break;
		case 1:
			player->setAddHp(player->getMaxHealth() * 0.2);
			player->revive(player->getMaxHealth() * 0.2);
			break;
		case 2:
			player->setAddHp(player->getMaxHealth() * 0.3);
...
void Skill::monsterSkill(Object* object, Monster* monster) {
	...
	case 2:
		switch (this->level) {
		case 0:
			player->revive(-player->getMaxHealth() * 0.05);
			break;
		case 1:
			player->revive(-player->getMaxHealth() * 0.10);
			break;
		case 2:
			player->revive(-player->getMaxHealth() * 0.15);
			break;
		}
		break;
	}
